...
<p>En esta pagina vemos el detalle de:</p>
<h1><?php print($datos['properties']['mag']);?></h1>
<h2><?php print($datos)['properties']['place']);?></h1>
...
<p>Ahora veamos los temblores sobre 4.5 registrados alrededor del mundo en el último mes:</p>
